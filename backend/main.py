...
from app.api import auth, documents, chat, agents, upload, generate, models, knowledge_bases, onboarding, bookmarks, incubation, qc_agent
...
app.include_router(qc_agent.router, prefix="/api/qc-agent", tags=["QC Agent"])
